...
import { y as SETTINGS_LINKS_CE, p as useEnterprise, u as useConfiguration, d as createRoute } from "./index-b9TUtGUa.mjs";
import sortBy from "lodash/sortBy";
import { useSelector } from "react-redux";
import { s as selectAdminPermissions } from "./AuthenticatedApp-riaX0bqk.mjs";
...
const useSettingsMenu = () => {
  ...
  const { admin: adminLinks, global: globalLinks } = useEnterprise(
    ceLinks,
    async () => (await import("./constants-yGtTecAp.mjs")).SETTINGS_LINKS_EE(),
    {
...
const ROUTES_CE = [
  {
    async Component() {
      const { ProtectedListPage } = await import("./ListPage-GzgYYtmk.mjs");
  ...
  {
    async Component() {
      const { ProtectedCreatePage } = await import("./CreatePage-EXRlBeTU.mjs");
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await import("./EditPage-IpoJS5rO.mjs");
  ...
  {
    async Component() {
      const { ProtectedListPage } = await import("./ListPage-bYTHiweO.mjs");
      return ProtectedListPage;
    },
    to: "/settings/users",
    exact: true
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await import("./EditPage-drzNgxSE.mjs");
      return ProtectedEditPage;
    },
  ...
  {
    async Component() {
      const { ProtectedCreatePage } = await import("./CreatePage-KinJzBfK.mjs");
      return ProtectedCreatePage;
    },
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await import("./EditPage-0Z8TqXxY.mjs").then((n) => n.b);
      return ProtectedEditPage;
    },
  ...
  {
    async Component() {
      const { ProtectedListPage } = await import("./ListPage-bKxvH7z1.mjs");
      return ProtectedListPage;
    },
  ...
  {
    async Component() {
      const { ProtectedListView } = await import("./ListView-vXmZKMHu.mjs");
  ...
  {
    async Component() {
      const { ProtectedCreateView } = await import("./CreateView-XkGXb6jg.mjs");
  ...
  {
    async Component() {
      const { ProtectedEditView } = await import("./EditViewPage-QA7Fd5u9.mjs");
  ...
  {
    async Component() {
      const { ProtectedCreateView } = await import("./CreateView-JQtnFUlZ.mjs");
      return ProtectedCreateView;
    },
  ...
  {
    async Component() {
      const { ProtectedListView } = await import("./ListView-eWw9mvz0.mjs");
      return ProtectedListView;
    },
  ...
  {
    async Component() {
      const { ProtectedEditView } = await import("./EditView-t_-XGK_U.mjs");
      return ProtectedEditView;
    },
...
const ApplicationInfoPage = () => {
  ...
  const AdminSeatInfo = useEnterprise(
    AdminSeatInfoCE,
    async () => (await import("./AdminSeatInfo-m8yR8BMU.mjs")).AdminSeatInfoEE
  );
  const {
...
const SettingsPage = () => {
  ...
  const routes = useEnterprise(
    ROUTES_CE,
    async () => (await import("./constants-zSvUC_X3.mjs")).ROUTES_EE,
    {
...
//# sourceMappingURL=SettingsPage-hIdNLgyU.mjs.map
